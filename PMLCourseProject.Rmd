...
`train`) features there are missing values, varying between `r min(featMissing[featMissing != 0])` and `r max(featMissing[featMissing != 0])` observations or 98 to 100 percent.
...
descriptive statistics (5-number summaries) and exploratory plots (boxplots, density plots and histograms) were generated for each of the `r ncol(pmlTrain2) -1` features. 
